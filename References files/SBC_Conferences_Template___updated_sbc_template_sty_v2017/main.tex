...
na existência exclusiva de pesos positivos. Dessa forma, ao analisar
seu comportamento em relação ao relaxamento de arestas adjacentes do
grafo, sua complexidade reflete a abordagem, configurando-se como
...
especialmente à medida que o grafo se torna mais denso, com um maior $|E|$.
