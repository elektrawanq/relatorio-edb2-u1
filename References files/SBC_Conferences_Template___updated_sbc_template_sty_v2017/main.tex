...
utilizou-se tamanho de entrada de até $5000$, de 10 em 10 iterações,
pois o artigo abordado está na área de redes, que geralmente os
testes são feitos com no máximo milhares, não atingindo milhões. Cada
$n$ foi iterado 32 vezes, a fim de calcular a média aritmética e
assim obter o tempo médio de execução, garantindo a integridade da
análise diante da variabilidade dos algoritmos.
...
tempo de execução, os dois algoritmos apresentam tempos quase
indistinguíveis, próximos a zero milissegundos, para as instâncias
iniciais. Contudo, à medida que a entrada ultrapassa a marca de 2000
vértices, a curva do Bellman-Ford se descola abruptamente para cima,
evidenciando um custo computacional consideravelmente mais acentuado
em relação ao crescimento mais brando do Dijkstra. Dessa forma, em
cenários de roteamento intra-domínio com mais de $2.000$ conexões e
roteadores, o Dijkstra torna-se ferramenta indispensável na prática.
...
|E|$. Diante dos resultados empíricos apresentados na Figura
\ref{fig:grafico_tempos}, o comportamento assintótico e o peso da
varredura exaustiva tornam-se substanciais a partir de $n = 2000$,
ponto em que a curva do Bellman-Ford demonstra um crescimento abrupto
e se distancia definitivamente da eficiência mantida pelo algoritmo de Dijkstra.
