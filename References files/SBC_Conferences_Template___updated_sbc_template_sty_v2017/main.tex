...
utilizou-se tamanho de entrada de até $5000$, de 10 em 10 iterações, pois o artigo abordado
está na área de redes, que geralmente os testes são feitos com no máximo milhares, não atingindo milhões. 
Cada $n$ foi iterado 32 vezes, a fim de calcular a média aritmética e assim 
obter o tempo médio de execução, garantindo a integridade da análise diante da variabilidade dos algoritmos.
