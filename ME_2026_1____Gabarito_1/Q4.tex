...
Seja $V$ a quantidade de anos vivida por Diofanto. Analisando o texto, as
partes da vida de Diofanto indicadas são as seguintes:
...
Seja a quantidade de anos vividas por Diofanto denotada por $x$. Do texto,
...
\begin{itemize}
    ...
    \item Depois de mais $\dfrac x7$ anos, se casou, aos $\dfrac x4 + \dfrac{x}{7} =
              \dfrac{11x}{28}$ anos;
    \item Com mais cinco anos, teve um filho, aos $\dfrac{11x}{28} + 5 =
              \dfrac{11x+140}{28}$ anos;
    \item Após $\dfrac x2$ anos, seu filho morreu, quando Diofanto tinha
          $\dfrac{11x+140}{28} + \dfrac x2 = \dfrac{25x+140}{28}$ anos;
    \item Diofanto morreu aos $\dfrac{25x+140}{28} + 4 = \dfrac{25x+252}{28}$. Como aqui
          ele morreu, chegamos aos $x$ anos.
\end{itemize}
