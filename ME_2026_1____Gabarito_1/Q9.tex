...
Sejam $a, b, c, d \in \R_+^\ast$.
Aplicando a desigualdade das médias aritmética e geométrica nos termos $a , b, c ,d$, temos:    
        \begin{align*}
            \sqrt[4]{a\cdot b\cdot c\cdot d} \leq \dfrac{a+b+c+d}{4}.\tag{I}\\
        \end{align*}
        
Agora, aplicando a desigualdade das médias harmônica e geométrica nos termos $a, b, c, d$, temos:
         \begin{align*}
...
Portanto, $(a+b+c+d) \cdot \left(\dfrac{1}{a}+\dfrac{1}{b}+\dfrac{1}{c}+\dfrac{1}{d}\right) \geq 16$, para quaisquer $a, b, c, d \in \R_+^\ast$.
