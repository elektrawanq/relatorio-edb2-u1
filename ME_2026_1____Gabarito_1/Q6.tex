...
Para tanto, precisamos que a equação $ax^2 + 4x + a = 0$ não tenha solução, ou seja, que $\Delta<0$. Segue:
\begin{align*}
...
\begin{center}
    ...
    Logo, a expressão é sempre diferente de zero quando $(a-2)(a+2) >0$, ou seja, quando $a\in(-\infty,-2)\cup(2,+\infty)$.
...
\begin{itemize}
    ...
    \item  Solução da inequação fazendo estudo do sinal da expressão fatorada\emph{(2,0 pontos)}.
\end{itemize} }