...
De uma das propriedades da união de conjuntos, sabemos: $A \subseteq (A \cup
    B)$.

Das propriedades de complementar de um conjunto, sabemos: $X \subseteq Y
    \implies Y^C \subseteq X^C$.
...
Perceba que, por De Morgan, $(A \cup B)^C = A^C\cap B^C$ e, em particular, $(A
    \cup B)^C \subseteq A^C\cap B^C$. Por propriedade de interseção, $A^C\cap
    B^C\subseteq A^C$. Logo, por transitividade, $(A \cup B)^C \subseteq A^C.$
